      ...
      <Grid item xs={11} sm={10} md={8} lg={6} xl={6}>
        <article className="about__article">
          ...
          <Typography variant="body1" paragraph>
            ...
            door andere installatiebedrijven en beschikken over hoge kwaliteit
            materialen om elke klus uit te voeren.
          </Typography>
          <Typography variant="body1" paragraph>
            Heeft u een probleem met uw elektrische installatie, wilt u een
            aanpassing vanwege een verbouwing of heeft u behoefte aan een nieuwe
            installatie? Dan bent u bij Ansa-techniek op het goede adres.
          </Typography>
          <Typography variant="body1" paragraph>
            ...
            uitstekende service te verlenen waar wij beiden tevreden over kunnen
            zijn.
          </Typography>
        </article>
      </Grid>
